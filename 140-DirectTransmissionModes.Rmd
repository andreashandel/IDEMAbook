...
The most straightforward way of transmission is transmission through direct contact from infected to uninfected host. A prime class of pathogens that follow this route are sexually transmitted infections (STI). For STI, the pathogen goes directly from one host to the other. Another pathogen for which direct contact is an important (but not the only) route of transmission is Ebola.
