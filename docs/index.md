...
* The online courses "Epidemics - the Dynamics of Infectious Diseases" [@epimooc] and "Epidemics" are highly recommended [@hkepidemics].
...
Both phenomenological (statistical) and mechanistic models are useful tools with distinct advantages and disadvantages. Deciding which one to use depends on the question and study system. In this book, we will focus on mechanistic models, which try to represent an explicit, simplified description of the system of interest. 
